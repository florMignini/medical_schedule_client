                ...
                {dayEvents.length > 0 && (
                  <>
                    <DrawerTrigger className="w-full flex items-center justify-center ">
                      <div className="flex items-center justify-center size-7 rounded-full border-[1px] border-black p-1">{dayEvents.length}</div>
                    </DrawerTrigger>
                    <DrawerContent>
                      <DrawerHeader>
                        <DrawerTitle>Eventos del dia</DrawerTitle>
                      </DrawerHeader>
                      <DrawerDescription>
