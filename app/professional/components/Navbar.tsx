        ...
        <div
            ...
            <div className="w-[100%] px-5 py-2 flex items-center justify-start gap-2">
                <div className="w-[60%] lg:w-[50%] flex items-center justify-start">
                    {/* route section */}
                    <div className="hidden md:w-[50%] md:flex items-center justify-start gap-2">
                    <button
                        onClick={() => router.back()}
                    >
                    ...
                    {/* welcome section */}
                    <div className="w-[80%] md:w-[50%] text-[20px] xl:text-2xl text-gradient text-clip font-medium">
                            <h2 className="capitalize">Bienvenid@, Dr. <strong>{professional?.lastname}</strong></h2>
                    </div>
                </div>
