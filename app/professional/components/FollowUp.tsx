...
const FollowUp = (patientInfo: Patient) => {
  ...
  console.log(followUpIncluded);
  return (
    <section className="w-full flex flex-col items-center justify-start gap-3">
      <div className="w-[95%] min-h-screen flex flex-col items-start justify-start bg-white px-2 py-3 shadow-[inset_0px_-2px_3px_rgba(73,73,73,0.2)] rounded-md">
        {/* title general */}
